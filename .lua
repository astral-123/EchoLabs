...
-- ============================================================
-- KEYBIND HELPERS (partagés partout dans le module)
-- ============================================================
...
-- Vérifie si un input correspond à une valeur keybind stockée
...
-- Lit un input et retourne la valeur à stocker (KeyCode ou UserInputType)
...
function library:CreateWindow(name, size, hidebutton)
	...
	updateevent.Event:Connect(function(theme) window.Line2.BackgroundColor3 = theme.accentcolor end)
	...
	updateevent.Event:Connect(function(theme) window.BlackLine.BackgroundColor3 = theme.outlinecolor2 end)
	...
	updateevent.Event:Connect(function(theme) window.Line.BackgroundColor3 = theme.accentcolor end)
	...
	window.MinimizeBtn.Name = "MinimizeBtn"
	...
	window.MinimizeBtn.MouseButton1Down:Connect(function()
		...
		if minimized then
			window.Frame:TweenSize(UDim2.fromOffset(window.size.X.Offset, window.theme.topheight), Enum.EasingDirection.In, Enum.EasingStyle.Sine, 0.15)
		else
	...
	for i = 1, 3 do
		...
		line.Rotation = -45
		updateevent.Event:Connect(function(theme) line.BackgroundColor3 = theme.outlinecolor end)
	end
	...
	function window:CreateTab(name)
		...
		updateevent.Event:Connect(function(theme)
			local s = textservice:GetTextSize(tab.name, theme.fontsize, theme.font, Vector2.new(200,300))
			...
			tab.TabButton.Size = UDim2.fromOffset(s.X + 15, window.TabList.AbsoluteSize.Y - 1)
		...
		function tab:SelectTab()
			...
			window.Line:TweenSizeAndPosition(
				UDim2.fromOffset(size.X + 15, 1),
				UDim2.new(0, (tab.TabButton.AbsolutePosition.X - window.Frame.AbsolutePosition.X), 0, 0) + (window.BlackLine.Position - UDim2.fromOffset(0, 1)),
		...
		function tab:CreateSector(name, side)
			...
			updateevent.Event:Connect(function(theme) sector.Line.BackgroundColor3 = theme.accentcolor end)
			...
			sector.Main:GetPropertyChangedSignal("Size"):Connect(function() sector.BlackOutline.Size = sector.Main.Size + UDim2.fromOffset(2, 2) end)
			updateevent.Event:Connect(function(theme) sector.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)
			...
			sector.Main:GetPropertyChangedSignal("Size"):Connect(function() sector.Outline.Size = sector.Main.Size + UDim2.fromOffset(4, 4) end)
			updateevent.Event:Connect(function(theme) sector.Outline.BackgroundColor3 = theme.outlinecolor end)
			...
			sector.Main:GetPropertyChangedSignal("Size"):Connect(function() sector.BlackOutline2.Size = sector.Main.Size + UDim2.fromOffset(6, 6) end)
			updateevent.Event:Connect(function(theme) sector.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)
			...
			sector.Label.Size = UDim2.fromOffset(math.clamp(textservice:GetTextSize(sector.name, 15, window.theme.font, Vector2.new(200,300)).X + 13, 0, sector.Main.Size.X.Offset), labelSize.Y)
			...
			updateevent.Event:Connect(function(theme)
				local s = textservice:GetTextSize(sector.name, 15, theme.font, Vector2.new(2000, 2000))
				sector.Label.Size = UDim2.fromOffset(math.clamp(textservice:GetTextSize(sector.name, 15, theme.font, Vector2.new(200,300)).X + 13, 0, sector.Main.Size.X.Offset), s.Y)
			...
			function sector:FixSize()
				...
				for i,v in pairs(tab.SectorsLeft)  do sizeleft  = sizeleft  + v.Main.AbsoluteSize.Y end
				for i,v in pairs(tab.SectorsRight) do sizeright = sizeright + v.Main.AbsoluteSize.Y end
			...
			function sector:AddLabel(text, color, centered)
				...
				function label:SetAccentColor(c) label.AccentBar.BackgroundColor3 = c end
			...
			function sector:AddButton(text, callback)
				...
				button.BlackOutline2.Name = "blackline" ; button.BlackOutline2.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) button.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)

				button.Outline = Instance.new("Frame", button.Main)
				button.Outline.Name = "blackline" ; button.Outline.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) button.Outline.BackgroundColor3 = theme.outlinecolor end)

				button.BlackOutline = Instance.new("Frame", button.Main)
				button.BlackOutline.Name = "blackline" ; button.BlackOutline.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) button.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)
				...
				button.BlackOutline2.MouseEnter:Connect(function() button.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end)
				button.BlackOutline2.MouseLeave:Connect(function() button.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2 end)
			...
			function sector:AddToggle(text, default, callback, flag)
				...
				updateevent.Event:Connect(function(theme) toggle.Main.BorderColor3 = theme.outlinecolor end)

				toggle.BlackOutline2 = Instance.new("Frame", toggle.Main)
				toggle.BlackOutline2.Name = "blackline" ; toggle.BlackOutline2.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) toggle.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)

				toggle.Outline = Instance.new("Frame", toggle.Main)
				toggle.Outline.Name = "blackline" ; toggle.Outline.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) toggle.Outline.BackgroundColor3 = theme.outlinecolor end)

				toggle.BlackOutline = Instance.new("Frame", toggle.Main)
				toggle.BlackOutline.Name = "blackline" ; toggle.BlackOutline.ZIndex = 4
				...
				updateevent.Event:Connect(function(theme) toggle.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)
				...
				function toggle:AddDropdown(items, default, multichoice, callback, flag)
					...
					updateevent.Event:Connect(function(theme) dropdown.Main.Font = theme.font end)
					...
					updateevent.Event:Connect(function(theme) dropdown.SelectedLabel.Font = theme.font end)
					...
					dropdown.BlackOutline2.Name = "blackline" ; dropdown.BlackOutline2.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) dropdown.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)

					dropdown.Outline = Instance.new("Frame", dropdown.Main)
					dropdown.Outline.Name = "blackline" ; dropdown.Outline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) dropdown.Outline.BackgroundColor3 = theme.outlinecolor end)

					dropdown.BlackOutline = Instance.new("Frame", dropdown.Main)
					dropdown.BlackOutline.Name = "blackline444" ; dropdown.BlackOutline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) dropdown.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)
					...
					dropdown.BlackOutline2Items.Name = "blackline3" ; dropdown.BlackOutline2Items.ZIndex = 7
					...
					updateevent.Event:Connect(function(theme) dropdown.BlackOutline2Items.BackgroundColor3 = theme.outlinecolor2 end)

					dropdown.OutlineItems = Instance.new("Frame", dropdown.Main)
					dropdown.OutlineItems.Name = "blackline8" ; dropdown.OutlineItems.ZIndex = 7
					...
					updateevent.Event:Connect(function(theme) dropdown.OutlineItems.BackgroundColor3 = theme.outlinecolor end)

					dropdown.BlackOutlineItems = Instance.new("Frame", dropdown.Main)
					dropdown.BlackOutlineItems.Name = "blackline3" ; dropdown.BlackOutlineItems.ZIndex = 7
					...
					updateevent.Event:Connect(function(theme) dropdown.BlackOutlineItems.BackgroundColor3 = theme.outlinecolor2 end)
					...
					function dropdown:isSelected(item)
						for i,v in pairs(dropdown.values) do if v == item then return true end end
						return false
					end
					...
					function dropdown:Add(v)
						...
						Item.ZIndex = 9 ; Item.Text = v ; Item.Name = v
						...
						Item.MouseButton1Down:Connect(function()
							if dropdown.multichoice then
								if dropdown:isSelected(v) then
									...
									table.insert(dropdown.values, v) ; dropdown:Set(dropdown.values)
								end
								return
							else
								dropdown.Nav.Rotation = 90
								dropdown.ItemsFrame.Visible = false ; dropdown.ItemsFrame.Active = false
								dropdown.OutlineItems.Visible = false ; dropdown.BlackOutlineItems.Visible = false
								dropdown.BlackOutline2Items.Visible = false
								dropdown.IgnoreBackButtons.Visible = false ; dropdown.IgnoreBackButtons.Active = false
							end
							dropdown:Set(v)
						end)
					...
					for i,v in pairs(dropdown.defaultitems) do dropdown:Add(v) end
					...
					local MouseButton1Down = function()
						if dropdown.Nav.Rotation == 90 then
							...
							if dropdown.items and #dropdown.items ~= 0 then
								...
								dropdown.ItemsFrame.Visible = true ; dropdown.ItemsFrame.Active = true
								dropdown.IgnoreBackButtons.Visible = true ; dropdown.IgnoreBackButtons.Active = true
								dropdown.OutlineItems.Visible = true ; dropdown.BlackOutlineItems.Visible = true ; dropdown.BlackOutline2Items.Visible = true
							end
						else
							tweenservice:Create(dropdown.Nav, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), { Rotation = 90 }):Play()
							dropdown.ItemsFrame.ScrollingEnabled = false ; sector.Main.Parent.ScrollingEnabled = true
							dropdown.ItemsFrame.Visible = false ; dropdown.ItemsFrame.Active = false
							dropdown.IgnoreBackButtons.Visible = false ; dropdown.IgnoreBackButtons.Active = false
							dropdown.OutlineItems.Visible = false ; dropdown.BlackOutlineItems.Visible = false ; dropdown.BlackOutline2Items.Visible = false
						end
					end

					dropdown.Main.MouseButton1Down:Connect(MouseButton1Down)
					dropdown.Nav.MouseButton1Down:Connect(MouseButton1Down)
					dropdown.BlackOutline2.MouseEnter:Connect(function() dropdown.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end)
					dropdown.BlackOutline2.MouseLeave:Connect(function() dropdown.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2 end)
				...
				function toggle:AddTextbox(default, callback, flag)
					...
					textbox.Holder.Name = "holder" ; textbox.Holder.ZIndex = 5
					...
					function textbox:Set(text)
						textbox.value = text ; textbox.Main.Text = text
						if textbox.flag and textbox.flag ~= "" then library.flags[textbox.flag] = text end
						pcall(textbox.callback, text)
					end
					updateevent.Event:Connect(function(theme) textbox.Main.Font = theme.font end)
					function textbox:Get() return textbox.value end
					if textbox.default then textbox:Set(textbox.default) end
					textbox.Main.FocusLost:Connect(function() textbox:Set(textbox.Main.Text) end)

					textbox.BlackOutline2 = Instance.new("Frame", textbox.Main)
					textbox.BlackOutline2.Name = "blackline" ; textbox.BlackOutline2.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) textbox.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)

					textbox.Outline = Instance.new("Frame", textbox.Main)
					textbox.Outline.Name = "blackline" ; textbox.Outline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) textbox.Outline.BackgroundColor3 = theme.outlinecolor end)

					textbox.BlackOutline = Instance.new("Frame", textbox.Main)
					textbox.BlackOutline.Name = "blackline" ; textbox.BlackOutline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) textbox.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)

					textbox.BlackOutline2.MouseEnter:Connect(function() textbox.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end)
					textbox.BlackOutline2.MouseLeave:Connect(function() textbox.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2 end)
				...
				function toggle:AddColorpicker(default, callback, flag)
					...
					colorpicker.BlackOutline2.Name = "blackline" ; colorpicker.BlackOutline2.ZIndex = 4
					...
					colorpicker.Outline.Name = "blackline" ; colorpicker.Outline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) colorpicker.Outline.BackgroundColor3 = theme.outlinecolor end)

					colorpicker.BlackOutline = Instance.new("Frame", colorpicker.Main)
					colorpicker.BlackOutline.Name = "blackline" ; colorpicker.BlackOutline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) colorpicker.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)

					colorpicker.BlackOutline2.MouseEnter:Connect(function() colorpicker.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end)
					...
					colorpicker.BlackOutline3.Name = "blackline" ; colorpicker.BlackOutline3.ZIndex = 98
					...
					updateevent.Event:Connect(function(theme) colorpicker.BlackOutline3.BackgroundColor3 = theme.outlinecolor2 end)

					colorpicker.Outline2 = Instance.new("Frame", colorpicker.MainPicker)
					colorpicker.Outline2.Name = "blackline" ; colorpicker.Outline2.ZIndex = 98
					...
					updateevent.Event:Connect(function(theme) colorpicker.Outline2.BackgroundColor3 = theme.outlinecolor end)

					colorpicker.BlackOutline3b = Instance.new("Frame", colorpicker.MainPicker)
					colorpicker.BlackOutline3b.Name = "blackline" ; colorpicker.BlackOutline3b.ZIndex = 98
					colorpicker.BlackOutline3b.Size = colorpicker.MainPicker.Size + UDim2.fromOffset(2, 2)
					colorpicker.BlackOutline3b.BorderSizePixel = 0
					colorpicker.BlackOutline3b.BackgroundColor3 = window.theme.outlinecolor2
					colorpicker.BlackOutline3b.Position = UDim2.fromOffset(-1, -1)
					updateevent.Event:Connect(function(theme) colorpicker.BlackOutline3b.BackgroundColor3 = theme.outlinecolor2 end)
					...
					updateevent.Event:Connect(function(theme) colorpicker.hue.BorderColor3 = theme.outlinecolor2 end)
					...
					updateevent.Event:Connect(function(theme) colorpicker.selector.BorderColor3 = theme.outlinecolor2 end)
					...
					if colorpicker.flag and colorpicker.flag ~= "" then library.flags[colorpicker.flag] = colorpicker.default end
					...
					function colorpicker:RefreshHue()
						...
						colorpicker:Set(Color3.fromHSV(colorpicker.color,math.clamp(x*colorpicker.hue.AbsoluteSize.X,0.5,colorpicker.hue.AbsoluteSize.X)/colorpicker.hue.AbsoluteSize.X,1-(math.clamp(y*colorpicker.hue.AbsoluteSize.Y,0.5,colorpicker.hue.AbsoluteSize.Y)/colorpicker.hue.AbsoluteSize.Y)))
					end
					...
					function colorpicker:Set(value)
						...
						if colorpicker.flag and colorpicker.flag ~= "" then library.flags[colorpicker.flag] = color end
						local c2 = Color3.new(math.clamp(color.R/1.7,0,1), math.clamp(color.G/1.7,0,1), math.clamp(color.B/1.7,0,1))
						colorpicker.Gradient.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0.00,color), ColorSequenceKeypoint.new(1.00,c2) })
					...
					colorpicker.selector.InputBegan:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging_selector = true ; colorpicker:RefreshSelector() end
					end)
					colorpicker.selector.InputEnded:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging_selector = false ; colorpicker:RefreshSelector() end
					end)
					colorpicker.hue.InputBegan:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging_hue = true ; colorpicker:RefreshHue() end
					end)
					colorpicker.hue.InputEnded:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging_hue = false ; colorpicker:RefreshHue() end
					end)
					uis.InputChanged:Connect(function(input)
						if dragging_selector and input.UserInputType == Enum.UserInputType.MouseMovement then colorpicker:RefreshSelector() end
						if dragging_hue     and input.UserInputType == Enum.UserInputType.MouseMovement then colorpicker:RefreshHue() end
					end)

					local inputBegan = function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then
							for i,v in pairs(window.OpenedColorPickers) do
								if v and i ~= colorpicker.MainPicker then i.Visible = false ; window.OpenedColorPickers[i] = false end
							end
							...
							colorpicker.BlackOutline2.BackgroundColor3 = colorpicker.MainPicker.Visible and window.theme.accentcolor or window.theme.outlinecolor2
						end
					end
				...
				function toggle:AddSlider(min, default, max, decimals, callback, flag)
					...
					slider.BlackOutline2.Name = "blackline" ; slider.BlackOutline2.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) slider.BlackOutline2.BackgroundColor3 = theme.outlinecolor2 end)

					slider.Outline = Instance.new("Frame", slider.Main)
					slider.Outline.Name = "blackline" ; slider.Outline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) slider.Outline.BackgroundColor3 = theme.outlinecolor end)

					slider.BlackOutline = Instance.new("Frame", slider.Main)
					slider.BlackOutline.Name = "blackline" ; slider.BlackOutline.ZIndex = 4
					...
					updateevent.Event:Connect(function(theme) slider.BlackOutline.BackgroundColor3 = theme.outlinecolor2 end)
					...
					slider.BlackOutline2.MouseEnter:Connect(function() slider.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end)
					slider.BlackOutline2.MouseLeave:Connect(function() slider.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2 end)

					if slider.flag and slider.flag ~= "" then library.flags[slider.flag] = slider.default or slider.min or 0 end
					...
					slider.SlideBar.InputBegan:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = true ; slider:Refresh() end
					end)
					...
					uis.InputChanged:Connect(function(input)
						if dragging and input.UserInputType == Enum.UserInputType.MouseMovement then slider:Refresh() end
					end)
				...
				toggle.Main.MouseButton1Down:Connect(function() toggle:Set(not toggle.CheckedFrame.Visible) end)
				toggle.Label.InputBegan:Connect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then toggle:Set(not toggle.CheckedFrame.Visible) end
				end)

				local MouseEnter = function() toggle.BlackOutline2.BackgroundColor3 = window.theme.accentcolor end
				local MouseLeave = function() toggle.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2 end
			...
			function sector:AddTextbox(text, default, callback, flag)
				...
				updateevent.Event:Connect(function(theme) textbox.Label.Font = theme.font end)
			...
			function sector:AddSlider(text, min, default, max, decimals, callback, flag)
				...
				slider.MainBack.Name = "MainBack" ; slider.MainBack.ZIndex = 7
				...
				local sz = textservice:GetTextSize(slider.Label.Text, slider.Label.TextSize, slider.Label.Font, Vector2.new(200,300))
				slider.InputLabel = Instance.new("TextBox", slider.MainBack)
				slider.InputLabel.BackgroundTransparency = 1
				slider.InputLabel.ClearTextOnFocus = false
				slider.InputLabel.Size = UDim2.fromOffset(sector.Main.Size.X.Offset - sz.X - 15, 12)
				slider.InputLabel.Font = window.theme.font
				slider.InputLabel.Text = "0"
				slider.InputLabel.TextColor3 = window.theme.itemscolor
				slider.InputLabel.Position = UDim2.fromOffset(sz.X + 3, -3)
				slider.InputLabel.TextSize = 15
				...
				updateevent.Event:Connect(function(theme)
					slider.InputLabel.Font = theme.font
					slider.InputLabel.TextColor3 = theme.itemscolor
					local s = textservice:GetTextSize(slider.Label.Text, slider.Label.TextSize, slider.Label.Font, Vector2.new(200,300))
					slider.InputLabel.Size = UDim2.fromOffset(sector.Main.Size.X.Offset - s.X - 15, 12)
				end)
			...
			function sector:AddColorpicker(text, default, callback, flag)
				...
				function colorpicker:AddDropdown(items, default, multichoice, callback, flag)
					...
					dropdown.BlackOutline = Instance.new("Frame", dropdown.Main)
					dropdown.BlackOutline.Name = "blackline" ; dropdown.BlackOutline.ZIndex = 4
					dropdown.BlackOutline.Size = dropdown.Main.Size + UDim2.fromOffset(2, 2)
					dropdown.BlackOutline.BorderSizePixel = 0
					dropdown.BlackOutline.BackgroundColor3 = window.theme.outlinecolor2
					dropdown.BlackOutline.Position = UDim2.fromOffset(-1, -1)
					...
					dropdown.BlackOutline2Items = Instance.new("Frame", dropdown.Main)
					dropdown.BlackOutline2Items.Name = "blackline" ; dropdown.BlackOutline2Items.ZIndex = 7
					dropdown.BlackOutline2Items.Size = dropdown.ItemsFrame.Size + UDim2.fromOffset(6,6)
					dropdown.BlackOutline2Items.BorderSizePixel = 0
					dropdown.BlackOutline2Items.BackgroundColor3 = window.theme.outlinecolor2
					dropdown.BlackOutline2Items.Position = dropdown.ItemsFrame.Position + UDim2.fromOffset(-3,-3)
					...
					dropdown.OutlineItems = Instance.new("Frame", dropdown.Main)
					dropdown.OutlineItems.Name = "blackline" ; dropdown.OutlineItems.ZIndex = 7
					dropdown.OutlineItems.Size = dropdown.ItemsFrame.Size + UDim2.fromOffset(4,4)
					dropdown.OutlineItems.BorderSizePixel = 0
					dropdown.OutlineItems.BackgroundColor3 = window.theme.outlinecolor
					dropdown.OutlineItems.Position = dropdown.ItemsFrame.Position + UDim2.fromOffset(-2,-2)
					...
					dropdown.BlackOutlineItems = Instance.new("Frame", dropdown.Main)
					dropdown.BlackOutlineItems.Name = "blackline" ; dropdown.BlackOutlineItems.ZIndex = 7
					dropdown.BlackOutlineItems.Size = dropdown.ItemsFrame.Size + UDim2.fromOffset(-2,-2)
					dropdown.BlackOutlineItems.BorderSizePixel = 0
					dropdown.BlackOutlineItems.BackgroundColor3 = window.theme.outlinecolor2
					dropdown.BlackOutlineItems.Position = dropdown.ItemsFrame.Position + UDim2.fromOffset(-1,-1)
					...
					function dropdown:Add(v)
						local Item = Instance.new("TextButton", dropdown.ItemsFrame)
						Item.BackgroundColor3 = Color3.fromRGB(40,40,40) ; Item.TextColor3 = Color3.fromRGB(255,255,255)
						Item.BorderSizePixel = 0 ; Item.Position = UDim2.fromOffset(0,0)
						Item.Size = UDim2.fromOffset(dropdown.Main.Size.X.Offset-4,20)
						Item.ZIndex = 9 ; Item.Text = v ; Item.Name = v
						Item.AutoButtonColor = false ; Item.Font = window.theme.font
						Item.TextSize = 15 ; Item.TextXAlignment = Enum.TextXAlignment.Left ; Item.TextStrokeTransparency = 1
						dropdown.ItemsFrame.CanvasSize = dropdown.ItemsFrame.CanvasSize + UDim2.fromOffset(0,Item.AbsoluteSize.Y)
						Item.MouseButton1Down:Connect(function()
							if dropdown.multichoice then
								if dropdown:isSelected(v) then
						...
						runservice.RenderStepped:Connect(function()
							if dropdown.multichoice and dropdown:isSelected(v) or dropdown.values[1]==v then
								Item.BackgroundColor3=Color3.fromRGB(64,64,64) ; Item.TextColor3=window.theme.accentcolor ; Item.Text=" "..v
							else
								Item.BackgroundColor3=Color3.fromRGB(40,40,40) ; Item.TextColor3=Color3.fromRGB(255,255,255) ; Item.Text=v
							end
						end)
						table.insert(dropdown.items,v)
						dropdown.ItemsFrame.Size = UDim2.fromOffset(dropdown.Main.Size.X.Offset, math.clamp(#dropdown.items*Item.AbsoluteSize.Y,20,156)+4)
					...
					local MouseButton1Down = function()
						if dropdown.Nav.Rotation == 90 then
							dropdown.ItemsFrame.ScrollingEnabled=true ; sector.Main.Parent.ScrollingEnabled=false
							tweenservice:Create(dropdown.Nav,TweenInfo.new(0.1,Enum.EasingStyle.Linear,Enum.EasingDirection.In),{Rotation=-90}):Play()
							dropdown.ItemsFrame.Visible=true ; dropdown.ItemsFrame.Active=true
							dropdown.IgnoreBackButtons.Visible=true ; dropdown.IgnoreBackButtons.Active=true
							dropdown.OutlineItems.Visible=true ; dropdown.BlackOutlineItems.Visible=true ; dropdown.BlackOutline2Items.Visible=true
			...
			function sector:AddDropdown(text, items, default, multichoice, callback, flag)
				...
				dropdown.MainBack.Name = "backlabel" ; dropdown.MainBack.ZIndex = 7
				...
				dropdown.ListPadding = Instance.new("UIPadding", dropdown.ItemsFrame)
				dropdown.ListPadding.PaddingTop=UDim.new(0,2) ; dropdown.ListPadding.PaddingBottom=UDim.new(0,2)
				dropdown.ListPadding.PaddingLeft=UDim.new(0,2) ; dropdown.ListPadding.PaddingRight=UDim.new(0,2)
				...
				dropdown.IgnoreBackButtons = Instance.new("TextButton", dropdown.Main)
				dropdown.IgnoreBackButtons.BackgroundTransparency=1 ; dropdown.IgnoreBackButtons.BorderSizePixel=0
				dropdown.IgnoreBackButtons.Position=UDim2.fromOffset(0,dropdown.Main.Size.Y.Offset+8)
				dropdown.IgnoreBackButtons.Size=UDim2.new(0,0,0,0) ; dropdown.IgnoreBackButtons.ZIndex=7
				dropdown.IgnoreBackButtons.Text="" ; dropdown.IgnoreBackButtons.Visible=false ; dropdown.IgnoreBackButtons.AutoButtonColor=false
				...
				function dropdown:GetOptions() return dropdown.values end
				function dropdown:updateText(text)
					if #text>=27 then text=text:sub(1,25)..".." end
					dropdown.SelectedLabel.Text=text
				end
				...
				function dropdown:Add(v)
					...
					Item.BorderSizePixel=0 ; Item.Position=UDim2.fromOffset(0,0)
					Item.Size=UDim2.fromOffset(dropdown.Main.Size.X.Offset-4,20)
					Item.ZIndex=9 ; Item.Text=v ; Item.Name=v ; Item.AutoButtonColor=false
					Item.Font=window.theme.font ; Item.TextSize=15
					Item.TextXAlignment=Enum.TextXAlignment.Left ; Item.TextStrokeTransparency=1
					dropdown.ItemsFrame.CanvasSize=dropdown.ItemsFrame.CanvasSize+UDim2.fromOffset(0,Item.AbsoluteSize.Y)
			...
			function sector:AddSeperator(text)
				...
				seperator.main.Name = "Main" ; seperator.main.ZIndex = 5
				...
				seperator.line.Name = "Line" ; seperator.line.ZIndex = 7
				...
				seperator.outline.Name = "Outline" ; seperator.outline.ZIndex = 6
				...
				updateevent.Event:Connect(function(theme) seperator.outline.BackgroundColor3 = theme.outlinecolor2 end)
				...
				sector.LabelBackFrame.Name = "LabelBack" ; sector.LabelBackFrame.ZIndex = 7
			...
			configSystem.Create = configSystem.sector:AddButton("Create", function()
				...
				if ConfigName:Get() and ConfigName:Get() ~= "" then
					...
					for i,v in pairs(library.flags) do
						if v ~= nil and v ~= "" then
							if typeof(v) == "Color3" then config[i] = {v.R,v.G,v.B}
							elseif tostring(v):find("Enum.KeyCode") then config[i] = v.Name
							elseif typeof(v) == "table" then config[i] = {v}
							else config[i] = v end
						end
					end
					writefile(configSystem.configFolder .. "/" .. ConfigName:Get() .. ".txt", httpservice:JSONEncode(config))
					for i,v in pairs(listfiles(configSystem.configFolder)) do
						if v:find(".txt") then Config:Add(tostring(v):gsub(configSystem.configFolder .. "\\", ""):gsub(".txt", "")) end
					end
				end
			end)
			...
			configSystem.Save = configSystem.sector:AddButton("Save", function()
				...
				if Config:Get() and Config:Get() ~= "" then
					for i,v in pairs(library.flags) do
						if v ~= nil and v ~= "" then
							if typeof(v) == "Color3" then config[i] = {v.R,v.G,v.B}
							elseif tostring(v):find("Enum.KeyCode") then config[i] = "Enum.KeyCode." .. v.Name
							elseif typeof(v) == "table" then config[i] = {v}
							else config[i] = v end
						end
					end
					...
					pcall(function()
						...
						for i,v in pairs(ReadConfig) do
							if typeof(v) == "table" then
								if typeof(v[1]) == "number" then NewConfig[i] = Color3.new(v[1],v[2],v[3])
								elseif typeof(v[1]) == "table" then NewConfig[i] = v[1] end
							elseif tostring(v):find("Enum.KeyCode.") then
								NewConfig[i] = Enum.KeyCode[tostring(v):gsub("Enum.KeyCode.","")]
							else NewConfig[i] = v end
						end
						...
						for i,v in pairs(library.flags) do
							for i2,v2 in pairs(library.items) do
								if i ~= nil and i ~= "" and i ~= "Configs_Name" and i ~= "Configs" and v2.flag ~= nil then
									if v2.flag == i then pcall(function() v2:Set(v) end) end
								end
							end
						end
					end)
	...
	-- ================================================================
	-- Onglet ⚙ automatique (keybind hide/show + couleurs)
	-- ================================================================
	local settingsTab = window:CreateTab("⚙")
	local settingsSector = settingsTab:CreateSector("Keybind", "left")

	settingsSector:AddKeybind(
		"Touche Hide/Show",
		window.hidekey,
		function(newKey)
			if newKey ~= "None" then window.hidekey = newKey end
		end,
		function() end,
		"settings_hide_key"
	)
	...
	colorSectorLeft:AddColorpicker("Accent",   window.theme.accentcolor,     function(c) window.theme.accentcolor=c     ; window:UpdateTheme(window.theme) end, "settings_accentcolor")
	colorSectorLeft:AddColorpicker("Accent 2", window.theme.accentcolor2,    function(c) window.theme.accentcolor2=c    ; window:UpdateTheme(window.theme) end, "settings_accentcolor2")
	colorSectorLeft:AddColorpicker("Fond",     window.theme.backgroundcolor, function(c) window.theme.backgroundcolor=c ; window:UpdateTheme(window.theme) end, "settings_backgroundcolor")
	colorSectorLeft:AddColorpicker("Top Bar",  window.theme.topcolor,        function(c) window.theme.topcolor=c ; window.theme.topcolor2=c ; window:UpdateTheme(window.theme) end, "settings_topcolor")
	colorSectorLeft:AddColorpicker("Secteurs", window.theme.sectorcolor,     function(c) window.theme.sectorcolor=c    ; window:UpdateTheme(window.theme) end, "settings_sectorcolor")

	local colorSectorRight = settingsTab:CreateSector("Couleurs Texte", "right")
	colorSectorRight:AddColorpicker("Texte Items",  window.theme.itemscolor,    function(c) window.theme.itemscolor=c    ; window:UpdateTheme(window.theme) end, "settings_itemscolor")
	colorSectorRight:AddColorpicker("Texte Items 2",window.theme.itemscolor2,   function(c) window.theme.itemscolor2=c   ; window:UpdateTheme(window.theme) end, "settings_itemscolor2")
	colorSectorRight:AddColorpicker("Texte Titre",  window.theme.toptextcolor,  function(c) window.theme.toptextcolor=c  ; window:UpdateTheme(window.theme) end, "settings_toptextcolor")
	colorSectorRight:AddColorpicker("Texte Tabs",   window.theme.tabstextcolor, function(c) window.theme.tabstextcolor=c ; window:UpdateTheme(window.theme) end, "settings_tabstextcolor")
	colorSectorRight:AddColorpicker("Contour",      window.theme.outlinecolor,  function(c) window.theme.outlinecolor=c  ; window:UpdateTheme(window.theme) end, "settings_outlinecolor")
